        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> All Services</a>
                    </li>
                    <li class="page-back"><a href="{{url('/')}}/admin/addProduct"><i class="fa fa-pencil" aria-hidden="true"></i> Add Services</a>
                    </li>
                </ul>
            </div>
            <div class="sb2-2-1">
                <h2>All Services Posted</h2>
                <center>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$item->id}}</td>
                            <td><a target="new" href="{{url('/')}}/services/{{$item->slung}}">{{$item->title}}</td>
                            <td>

                            </td>
                            <td>
                                <a target="new" href="{{url('/')}}/services/{{$item->slung}}"><img width="150" src="{{url('/')}}/uploads/services/{{$item->image}}"></a>
                            </td>
