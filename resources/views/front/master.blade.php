...
<div class="page-wrapper">
    ...
    <header class="main-header header-style-two">
                ...
                <div class="clearfix">
					...
					<div class="top-left clearfix">
						...
						<ul class="info-list">
							...
							<li><a href="contact.html"><span class="icon fa fa-location-arrow"></span> Tom Mboya Street
                                Nairobi, Kenya
                                49939-00100</a></li>
						</ul>
					</div>
					...
					<nav class="main-menu navbar-expand-md">
						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
								<li class="current"><a href="#"><span class="fa fa-home"></span> Home</a>
        ...
        <div class="sticky-header">
            <div class="auto-container clearfix">
                ...
                <div class="logo pull-left">
                    <a href="index.html" title=""><img src="{{asset('corporate/images/logo-small.png')}}" alt="" title=""></a>
                </div>
                <!--Right Col-->
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="{{asset('corporate/images/logo.png')}}" alt="" title=""></a></div>
				...
				<div class="sidebar-textwidget">
					...
					<div class="sidebar-info-contents">
						<div class="content-inner">
							<div class="logo">
								<a href="index.html"><img src="{{asset('corporate/images/logo-2.png')}}" alt="" /></a>
							</div>
		...
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<div class="team-block-two col-lg-3 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="team.html"><img src="{{asset('corporate/images/resource/team-1.jpg')}}" alt="" /></a>
						</div>
						<div class="lower-box">
							<!-- Social Box -->
							<ul class="social-box">
							...
							<div class="row clearfix">
								...
								<div class="image-column col-lg-7 col-md-12 col-sm-12">
									<div class="inner-column">
										...
										<div class="image">
											<a href="news-detail.html"><img src="{{asset('corporate/images/resource/news-4.jpg')}}" alt="" /></a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="footer-column col-lg-6 col-md-6 col-sm-12">
								<div class="footer-widget news-widget">
									...
									<div class="widget-content">
										<div class="post">
											<div class="thumb"><a href="news-detail.html"><img src="{{asset('corporate/images/resource/post-thumb-3.jpg')}}" alt=""></a></div>
											<h6><a href="news-detail.html">Define World Best IT Solution Technology</a></h6>
											<span class="date">May 01, 2020</span>
										</div>

										<div class="post">
											<div class="thumb"><a href="news-detail.html"><img src="{{asset('corporate/images/resource/post-thumb-4.jpg')}}" alt=""></a></div>
								...
								<div class="footer-widget contact-widget">
									...
									<ul>
										<li>
											...
											Tom Mboya Street Nairobi, Kenya 49939-00100
										</li>
										<li>
				...
				<div class="auto-container">
					<div class="row clearfix">
						...
						<div class="column col-lg-6 col-md-12 col-sm-12">
							<div class="copyright">Copyright &copy; 2022 by Royal Tech Computers | All Rights Reserved.</div>
						</div>
						<!-- Column -->
						<div class="column col-lg-6 col-md-12 col-sm-12">
							<ul class="footer-nav">
